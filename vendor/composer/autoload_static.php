...
class ComposerStaticInit135aa7a370505161799f9dca3cb87238
{
    ...
    public static $classMap = array (
        ...
        'App\\Middleware\\PreventBack' => __DIR__ . '/../..' . '/App/Middleware/PreventBack.php',
        'App\\Models\\User' => __DIR__ . '/../..' . '/App/Models/User.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Core\\Auth' => __DIR__ . '/../..' . '/Core/Auth.php',
        'Core\\Controller' => __DIR__ . '/../..' . '/Core/Controller.php',
        'Core\\Datatables' => __DIR__ . '/../..' . '/Core/Datatables.php',
        'Core\\Model' => __DIR__ . '/../..' . '/Core/Model.php',
        'Core\\Validate' => __DIR__ . '/../..' . '/Core/Validate.php',
        'Core\\View' => __DIR__ . '/../..' . '/Core/View.php',
        'Facades\\CSRF' => __DIR__ . '/../..' . '/Facades/CSRF.php',
        'Facades\\Config' => __DIR__ . '/../..' . '/Facades/Config.php',
        'Facades\\DB' => __DIR__ . '/../..' . '/Facades/DB.php',
        'Facades\\ExpiredPage' => __DIR__ . '/../..' . '/Facades/ExpiredPage.php',
        'Facades\\Hash' => __DIR__ . '/../..' . '/Facades/Hash.php',
        'Facades\\Redirect' => __DIR__ . '/../..' . '/Facades/Redirect.php',
        'Facades\\Requisition' => __DIR__ . '/../..' . '/Facades/Requisition.php',
        'Facades\\Route' => __DIR__ . '/../..' . '/Facades/Route.php',
        'Facades\\Router' => __DIR__ . '/../..' . '/Facades/Router.php',
        'Facades\\Storage' => __DIR__ . '/../..' . '/Facades/Storage.php',
        'Facades\\Str' => __DIR__ . '/../..' . '/Facades/Str.php',
        'Facades\\Unauthorized' => __DIR__ . '/../..' . '/Facades/Unauthorized.php',
        ...
        'database\\Seeders' => __DIR__ . '/../..' . '/database/Seeders.php',
        'database\\factories\\UserFactory' => __DIR__ . '/../..' . '/database/factories/UserFactory.php',
        'database\\migrations\\UserMigration' => __DIR__ . '/../..' . '/database/migrations/UserMigration.php',
    );
